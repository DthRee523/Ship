#include "meterwidget1.h"
#include "ui_meterwidget1.h"

MeterWidget1::MeterWidget1(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MeterWidget1)
{
    ui->setupUi(this);
...
MeterWidget1::~MeterWidget1()
{
    delete ui;
}

void MeterWidget1::UpdateAngle(int value)
{
    this->m_value = value;
}

void MeterWidget1::updateLight(int index)
{
    this->light = index;
}

void MeterWidget1::paintEvent(QPaintEvent *event)
{
...
void MeterWidget1::drawCrown(QPainter *painter)
{
    painter->save();
    int radius = 100;
...
void MeterWidget1::drawBackground(QPainter *painter)
{

}

void MeterWidget1::drawScale(QPainter *painter)
{
    painter->save();
...
void MeterWidget1::drawScaleNum(QPainter *painter)
{
    painter->save();
...
void MeterWidget1::drawTitle(QPainter *painter)
{
    painter->save();
    painter->setPen(m_foreground);
...
void MeterWidget1::drawIndicator(QPainter *painter)
{
    painter->save();
    QPolygon pts;
...
void MeterWidget1::drawNumericValue(QPainter *painter)
{
...
void MeterWidget1::timerEvent(QTimerEvent *event)
{
    this->update();
}
